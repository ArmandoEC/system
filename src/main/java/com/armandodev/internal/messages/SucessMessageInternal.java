...
public class SucessMessageInternal extends javax.swing.JDialog {
    
    public SucessMessageInternal(java.awt.Frame parent, boolean modal, String titulo, String Mensagem) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SucessMessageInternal dialog = new SucessMessageInternal(new javax.swing.JFrame(), true, null, null);
    ...
    private void initComponents() {
        ...
        rSLabelImage1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/messages/Icone_sucess.png"))); // NOI18N
