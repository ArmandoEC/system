...
public class AlertMessageInternal extends javax.swing.JDialog {
    
    public AlertMessageInternal(java.awt.Frame parent, boolean modal, String titulo, String subTitulo, String Mensagem) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertMessageInternal dialog = new AlertMessageInternal(new javax.swing.JFrame(), true, null, null, null);
    ...
    private void initComponents() {
        ...
        rSLabelImage1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/messages/Icone_alert.png"))); // NOI18N
