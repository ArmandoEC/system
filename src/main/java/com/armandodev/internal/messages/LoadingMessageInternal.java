...
public class LoadingMessageInternal extends javax.swing.JDialog {

    public LoadingMessageInternal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoadingMessageInternal dialog = new LoadingMessageInternal(new javax.swing.JFrame(), true);
